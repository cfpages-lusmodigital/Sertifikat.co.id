...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Jasa Konstruksi Sertifikasi &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.2.2" media="all">
	...
	<link rel="icon" href="/wp-content/uploads/2023/06/favicon_sertifikat.co_.id_ix-removebg-preview.png" sizes="32x32">
<link rel="icon" href="/wp-content/uploads/2023/06/favicon_sertifikat.co_.id_ix-removebg-preview.png" sizes="192x192">
<link rel="apple-touch-icon" href="/wp-content/uploads/2023/06/favicon_sertifikat.co_.id_ix-removebg-preview.png">
<meta name="msapplication-TileImage" content="/wp-content/uploads/2023/06/favicon_sertifikat.co_.id_ix-removebg-preview.png">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://sertifikat.co.id.test/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://sertifikat.co.id.test/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Jasa Konstruksi Sertifikasi</a>		</p>
			</div>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"94faebf229"};</script>
